...
include "../var.php";
 ...
 if(isset($_POST['task_name']))
 {
    try{
        ...
        //echo 'Connection error: ' . $error->getMessage() ."<br>"; //a mettre dans un fichier a la racine

    }
    if (isset($error)){
        
        header('Location: ../../../pages/nouvel_element/nouvel_element.html?result_task=error1');
        echo "test1";
    }
    else{
 ...
 {
    header('Location: ../../../pages/nouvel_element/nouvel_element.html?result_task=error');
